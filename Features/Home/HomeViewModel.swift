struct HomeViewModel {
    ...
    let title = "Start from a clean daily shell"
    let message = "Home will become the dashboard for daily priorities, consistency signals, and quick actions in later stages."
    let highlights = [
